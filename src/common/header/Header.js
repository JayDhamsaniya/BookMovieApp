    ...
    return (
        <div className="header">
            ...
            <span style={{float: "right"}}>
                {button}
                {session ? <Button variant="contained" color="default" style={{marginLeft: "10px"}}
            ...
            >
                ...
                <TabPanel value={value} index={0}>
                    <div style={{margin: "20px", padding: "0 20px"}}>
                        <FormControl required className="formControl">
                            ...
                            <FormHelperText className={requsername}><span
                        ...
                        <FormControl required className="formControl">
                            ...
                            <Input id="password" type="password" name="password" onChange={inputPasswordHandler}/>
                            <FormHelperText className={reqpassword}><span
                                className="red">Required</span></FormHelperText>
                        </FormControl>
                        <br/>
                        <br/>
                ...
                <TabPanel value={value} index={1}>
                    <div style={{margin: "20px", padding: "0 20px"}}>
                        ...
                        <br/>
                        <br/>
                        <FormHelperText className={showdisplay} style={{fontSize: "14px", color: "black"}}>Registration
                            Successful. Please Login!</FormHelperText>
                        <br/>
                        <div style={{textAlign: "center"}}>
